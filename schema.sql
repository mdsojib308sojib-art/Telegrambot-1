-- Railway / PostgreSQL schema for PRO_TM_VIDEO_ZOOM
-- Updated from the uploaded V7→V20.7 schema.
-- Safe to run repeatedly: existing CREATE/ALTER/INSERT migrations are idempotent.
-- IMPORTANT: This file is PostgreSQL SQL. Do not add SQLite PRAGMA or AUTOINCREMENT syntax.
...
-- ============================================================
-- V20.7 START VIDEO BEHAVIOR
-- tutorial_settings is retained for backward compatibility.
-- Runtime rule:
--   Mini Bot         /start -> configured Start Video + existing welcome/buttons
--   Notification Bot /start -> configured Start Video + existing welcome/buttons
--   Video Bot        /start -> unchanged, no Start Video
-- Start Video is repeatable on every normal /start.
-- Owner or an admin with can_manage_settings can configure it.
-- ============================================================

-- V21.5 Dynamic package notification buttons
...
-- V22 Video Bot mandatory channel join verification
...
-- V23 Editable Mini App loading screen
